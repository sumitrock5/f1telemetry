...
delta[0]=delta[1]
delta[len(delta)-1]=delta[len(delta)-2]
...
sectors = {
    ...
    "Sector 2": (circuit_corner_length[7]+100, circuit_corner_length[15]+100),
    "Sector 3": (circuit_corner_length[15]+100, max(distance_lec)),
}
...
for x in circuit_corner_length:
    ...
    if c==16:
        ax2.text(x-10, ax2.get_ylim()[1]*0.3, "T"+circuit_corner_number[c],
            color='white', fontsize=10, rotation=90,
            ha='center', va='bottom', fontweight='medium')
        c=c+1
        continue
    if c==13:
        ax2.text(x-10, ax2.get_ylim()[1]*0.5, "T"+circuit_corner_number[c],
            color='white', fontsize=10, rotation=90,
            ha='center', va='bottom', fontweight='medium')
        c=c+1
        continue
