...
# saving data in csv
import csv
Miami2025_data_lec = [vCar_lec,
        t_lec, lec_tel['Distance']]
with open("Miami2025_data_lec.csv", "w", newline="") as file:
    writer = csv.writer(file)
    writer.writerows(Miami2025_data_lec)

import csv
Miami2025_data_ham = [vCar_ham,
        t_ham, ham_tel['Distance']]
with open("Miami2025_data_ham.csv", "w", newline="") as file:
    writer = csv.writer(file)
    writer.writerows(Miami2025_data_ham)
