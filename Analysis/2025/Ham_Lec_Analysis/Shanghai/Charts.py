...
sectors = {
    ...
    "Sector 2": (circuit_corner_length[4]+100, circuit_corner_length[10]-100),
    "Sector 3": (circuit_corner_length[10]-100, max(distance_lec)),
}
...
for x in circuit_corner_length:
    ...
    if c>4 and c<9:
        ax2.text(x-10, -ax2.get_ylim()[1]*4, "T"+circuit_corner_number[c],
            color='white', fontsize=10, rotation=90,
            ha='center', va='bottom', fontweight='medium')
        c=c+1
        continue
    ax2.text(x-10, -ax2.get_ylim()[1]*1.8, "T"+circuit_corner_number[c],
            color='white', fontsize=10, rotation=90,
            ha='center', va='bottom', fontweight='medium')
    c=c+1

# Y-axis tick labels: add +/− ms
ax2.set_yticks([round_sig(min(delta), 3), 0])
ax2.set_yticklabels([str(round_sig(min(delta), 3)) , '0'], color='white', fontsize=11)
