...
sectors = {
    "Sector 1": (0, circuit_corner_length[4]-100),
    "Sector 2": (circuit_corner_length[4]-100, circuit_corner_length[11]+100),
    "Sector 3": (circuit_corner_length[11]+100, max(distance_lec)),
}
...
for x in circuit_corner_length:
    ...
    if c==9 or c==12 or c==13 or c==14:
        ax2.text(x-10, ax2.get_ylim()[1]*0.30, "T"+circuit_corner_number[c],
            color='white', fontsize=10, rotation=90,
            ha='center', va='bottom', fontweight='medium')
        c=c+1
        continue

    ax2.text(x-10, ax2.get_ylim()[1]*0.80, "T"+circuit_corner_number[c],
            color='white', fontsize=10, rotation=90,
            ha='center', va='bottom', fontweight='medium')
    c=c+1
