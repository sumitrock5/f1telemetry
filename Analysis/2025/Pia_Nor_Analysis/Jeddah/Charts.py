...
draw.text((30, 70), "Driver 1: CHARLES Piastri", font=font_label, fill="crimson")
draw.text((750, 70), "Driver 2: LEWIS Norris", font=font_label, fill="gold")
...
sectors = {
    ...
    "Sector 3": (circuit_corner_length[20]+100, max(distance_pia)),
}
